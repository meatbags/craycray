  ...
  _createClass(Menu, [{
    ...
    value: function events() {
      ...
      $('.image_sequence').on('mouseleave', function (evt) {
        ...
        var max = _this2.frameInterval * index;
