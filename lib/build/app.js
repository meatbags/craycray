...
var Eye = function () {
  ...
  _createClass(Eye, [{
    ...
    value: function roll(mouseX, mouseY) {
      ...
      var len = this.pupilExtension * this.scale;
    ...
    value: function resize() {
      ...
      if (!this.resizing) {
        ...
        setTimeout(function () {
          ...
          _this4.offset.glow = 29 * _this4.scale;
          _this4.offset.pupil = -22 * _this4.scale;

          _this4.resizeImage(_this4.eye.base, _this4.centre.relative.x, _this4.centre.relative.y, _this4.scale);
          _this4.resizeImage(_this4.eye.glow, _this4.centre.relative.x, _this4.centre.relative.y + _this4.offset.glow, _this4.scale);
          _this4.resizeImage(_this4.eye.pupil, _this4.centre.relative.x, _this4.centre.relative.y + _this4.offset.pupil, _this4.scale);
