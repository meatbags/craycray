  ...
  resize() {
    ...
    if (!this.resizing) {
      ...
      setTimeout(() => {
        ...
        this.resizeImage(this.eye.glow, this.centre.relative.x, this.centre.relative.y, this.scale);
        this.resizeImage(this.eye.pupil, this.centre.relative.x, this.centre.relative.y, this.scale);
